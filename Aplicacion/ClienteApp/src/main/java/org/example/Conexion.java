...
public class Conexion {
    ...
    private static final String EJB_MODELO = "ejb:/ServidorApp-1.0-SNAPSHOT/ModelosEquiposBean!codigocreativo.uy.servidorapp.servicios.ModeloEquiposRemote"; // Nombre del EJB de modelo
