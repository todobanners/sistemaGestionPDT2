...
VALUES ('HOSPITAL MACIEL');

INSERT INTO PERFILES (NOMBRE_PERFIL)
VALUES ('ADMINISTRADOR');

INSERT INTO USUARIOS (CEDULA, NOMBRE, APELLIDO, ID_PERFIL, ID_INSTITUCION, EMAIL, NOMBRE_USUARIO, CONTRASENIA,
                      FECHA_NACIMIENTO)
VALUES ('91397684', 'ADMIN', 'ADMIN', (SELECT ID_PERFIL FROM PERFILES WHERE NOMBRE_PERFIL = 'ADMINISTRADOR'),
        (SELECT ID_INSTITUCION FROM INSTITUCIONES WHERE NOMBRE = 'HOSPITAL MACIEL'), 'test@gmail.com', 'admin', 'admin',
        TO_DATE('1990-01-01', 'YYYY-MM-DD'));
INSERT INTO PERMISOS (TIPO_PERMISO)
VALUES ('TODO');

INSERT INTO MARCAS_MODELO (NOMBRE)
VALUES ('GENERAL ELECTRIC');

INSERT INTO MODELOS_EQUIPOS (ID_MARCA, NOMBRE)
VALUES ((SELECT ID_MARCA FROM MARCAS_MODELO WHERE NOMBRE = 'GENERAL ELECTRIC'), 'LOGIQ E9');

INSERT INTO TIPOS_EQUIPOS (NOMBRE_TIPO) VALUES ('ECOGRAFO');

--Solucionar problema de Hibernate
ALTER TABLE UBICACIONES MODIFY ESTADO VARCHAR(15) DEFAULT ON NULL 'ACTIVO' NOT NULL;
...
INSERT INTO PROVEEDORES_EQUIPOS (NOMBRE) VALUES ('MARE SA');
